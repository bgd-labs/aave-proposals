...
lusd-strategy :;  forge script script/DeployLUSDV3Utils.s.sol:DeployLUSDStrategy --rpc-url ${RPC_MAINNET} --legacy --ledger --mnemonic-indexes ${MNEMONIC_INDEX} --sender ${LEDGER_SENDER} --verify --etherscan-api-key ${ETHERSCAN_API_KEY_MAINNET} -vvvv