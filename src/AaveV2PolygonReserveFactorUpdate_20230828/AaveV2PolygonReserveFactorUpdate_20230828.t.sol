...
contract AaveV2PolygonReserveFactorUpdate_20230828_Test is ProtocolV2TestBase {
  function setUp() public {
    vm.createSelectFork(vm.rpcUrl('polygon'), 46956529);
  }
  ...
  function testpayload() public {
    ...
    AaveV2PolygonReserveFactorUpdate_20230828 payload = AaveV2PolygonReserveFactorUpdate_20230828(0x40fa5610f17A99D20bD428810bEc965fe4694238);
