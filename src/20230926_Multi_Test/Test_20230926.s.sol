...
contract DeployEthereum is EthereumScript {
  function run() external broadcast {
    // deploy payloads
    AaveV2Ethereum_Test_20230926 payload0 = new AaveV2Ethereum_Test_20230926();
    AaveV2EthereumAMM_Test_20230926 payload1 = new AaveV2EthereumAMM_Test_20230926();
...
contract CreateProposal is EthereumScript {
  function run() external broadcast {
    ...
    GovV3Helpers.createProposal(
      payloads,
      GovHelpers.ipfsHashFile(vm, 'src/20230926_Multi_Test/Test.md')
    );
  }
}
