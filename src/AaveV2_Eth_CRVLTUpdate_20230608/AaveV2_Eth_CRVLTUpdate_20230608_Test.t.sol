...
/**
 * @dev Test for AaveV2_Eth_CRVLTUpdate_20230608
 * command: make test-contract filter=AaveV2_Eth_CRVLTUpdate_20230608
 */
contract AaveV2_Eth_CRVLTUpdate_20230608_Test is ProtocolV2TestBase {
  ...
  function testProposalExecution() public {
    AaveV2_Eth_CRVLTUpdate_20230608 proposal = new AaveV2_Eth_CRVLTUpdate_20230608();
    ReserveConfig[] memory allConfigsBefore = createConfigurationSnapshot(
      'preAaveV2_Eth_CRVLTUpdate_20230608_Test',
      AaveV2Ethereum.POOL
    );
