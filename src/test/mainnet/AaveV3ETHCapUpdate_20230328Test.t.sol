...
contract AaveV3EthCBETHSupplyCapsPayload_29032023Test is ProtocolV3TestBase, TestWithExecutor {
  ...
  function testSupplyCapsEth() public {
    ...
    createConfigurationSnapshot('preAaveV3EthCBETHSupplyCapsPayload_29032023Change', AaveV3Ethereum.POOL);
    ...
    createConfigurationSnapshot('postAaveV3EthCBETHSupplyCapsPayload_29032023Change', AaveV3Ethereum.POOL);
    ...
    // 5. compare snapshots
    diffReports('preAaveV3EthCBETHSupplyCapsPayload_29032023Change', 'postAaveV3EthCBETHSupplyCapsPayload_29032023Change');
  }
}
