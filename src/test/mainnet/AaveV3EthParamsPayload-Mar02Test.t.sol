...
contract AaveV3EthParamsPayloadTest is ProtocolV3TestBase, TestWithExecutor {
  ...
  function testParamsEth() public {
    ...
    // USDC
    ReserveConfig memory USDCConfig = ProtocolV3TestBase._findReserveConfig(allConfigsBefore, AaveV3EthereumAssets.USDC_UNDERLYING);
    ...
    // DAI
    ReserveConfig memory DAIConfig = ProtocolV3TestBase._findReserveConfig(allConfigsBefore, AaveV3EthereumAssets.DAI_UNDERLYING);
