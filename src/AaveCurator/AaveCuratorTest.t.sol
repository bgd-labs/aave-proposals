...
contract AaveCuratorTest is Test {
  ...
  function setUp() public {
    vm.createSelectFork(vm.rpcUrl('mainnet'), 17770600);
...
contract CancelSwap is AaveCuratorTest {
  ...
  function test_successful() public {
    ...
    curator.cancelSwap(
      0xd5e77e96702694039D6E269cC116cc308806f48A, // Address generated by tests
      AaveV2EthereumAssets.AAVE_UNDERLYING,
      AaveV2EthereumAssets.USDC_UNDERLYING,
      address(AaveV2Ethereum.COLLECTOR),
      1_000e18,
...
contract GetExpectedOut is AaveCuratorTest {
  ...
  function test_aaveToUsdc_withEthBasedOracles() public {
    ...
    // July 25, 2023 10:15AM EST AAVE/USD is around $70.50
    assertEq(expected / 1e16, 7063);
  }
  ...
  function test_ethToDai() public {
    ...
    // July 25, 2023 10:15AM EST ETH/USD is around $1,862
    assertEq(expected / 1e18, 1862);
  }
  ...
  function test_ethToBal() public {
    ...
    // July 25, 2023 10:15AM EST ETH/USD is around $1,862, BAL/USD $4.50
    // Thus, ETH/BAL should be around 413 BAL tokens
    assertEq(expected / 1e18, 413);
  }
