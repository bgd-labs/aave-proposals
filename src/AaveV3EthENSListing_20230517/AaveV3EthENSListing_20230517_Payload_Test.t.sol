...
contract AaveV3EthENSListing_20230517_Payload_Test is ProtocolV3_0_1TestBase, TestWithExecutor {
    ...
    function testPoolActivation() public {
        ...
        _validateAssetSourceOnOracle(
            AaveV3Ethereum.POOL_ADDRESSES_PROVIDER, payload.ENS(), payload.ENS_PRICE_FEED()
        );

        createConfigurationSnapshot("post-Aave-V3-Ethereum-ENS-Listing", AaveV3Ethereum.POOL);
