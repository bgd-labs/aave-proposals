...
contract AaveV3ArbPriceFeedsUpdate_20230613_PayloadTest is ProtocolV3TestBase {
  ...
  function testPayload() public {
    AaveV3ArbPriceFeedsUpdate_20230613_Payload payload = new AaveV3ArbPriceFeedsUpdate_20230613_Payload();
    ...
    createConfigurationSnapshot(
      'postAaveV3ArbPriceFeedsUpdate_20230613_PayloadChange',
      AaveV3Arbitrum.POOL
    );
    ...
    // 5. compare snapshots
    diffReports(
      'preAaveV3ArbPriceFeedsUpdate_20230613Change',
      'postAaveV3ArbPriceFeedsUpdate_20230613_PayloadChange'
    );
