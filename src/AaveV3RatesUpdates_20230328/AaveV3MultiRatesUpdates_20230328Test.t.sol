...
contract AaveV3PolRatesUpdates_20230328Test is ProtocolV3LegacyTestBase {
  ...
  function testExecuteValidation() public {
    ...
    GovHelpers.executePayload(
      vm,
      address(new AaveV3PolRatesUpdates_20230328()),
...
contract AaveV3EthRatesUpdates_20230328Test is ProtocolV3TestBase {
  function setUp() public {
  ...
  function testExecuteValidation() public {
    ...
    GovHelpers.executePayload(
      vm,
      address(new AaveV3EthRatesUpdates_20230328()),
